 ...
 * @author G0NN4 CRY
 */
public class CompraItem extends javax.swing.JFrame {

    private ComprasItensController controlador;

    public CompraItem() throws BancoDeDadosException {
        initComponents();
    ...
    public void preencheTabela() {
        ...
        for (int i = 0; i < this.controlador.getListaComprasItens().size(); i++) {
            ...
            ((DefaultTableModel) this.jtCompraItens.getModel()).addRow(
                    new Object[]{
    ...
    private void initComponents() {
        ...
        jtCompraItens = new javax.swing.JTable();
        ...
        jtCompraItens.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Quantidade", "Valor", "Compras_id", "Produtos_id"
            }
        ) {
        ...
        jScrollPane1.setViewportView(jtCompraItens);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            // TODO add your handling code here:
            NovoCompraItem novoItem = new NovoCompraItem();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (this.jtCompraItens.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(rootPane, "Selecione um registro da tabela primeiramente!");
        } else {
            try {
                EditarCompraItem editarItem = new EditarCompraItem();
                this.controlador.setCompraItensSelecionado(this.jtCompraItens.getSelectedRow());
                editarItem.setControlador(this.controlador);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (this.jtCompraItens.getSelectedRow() == -1) {
            ...
            try {
                ...
                DefaultTableModel tabela = (DefaultTableModel) this.jtCompraItens.getModel();

                int row = jtCompraItens.getSelectedRow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompraItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new CompraItem().setVisible(true);
                } catch (BancoDeDadosException ex) {
                    Logger.getLogger(CompraItem.class.getName()).log(Level.SEVERE, null, ex);
                }
            }

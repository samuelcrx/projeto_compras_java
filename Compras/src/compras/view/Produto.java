...
public class Produto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Importar dados");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         ...
         try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Produtos importados com sucesso");
        } catch (IntegracaoException | IOException | BancoDeDadosException ex) {
            JOptionPane.showMessageDialog(rootPane, "Erro ao importar produtos " + ex);
